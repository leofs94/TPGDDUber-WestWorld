...
namespace PagoAgilFrba {
    ...
    public partial class GD2C2017DataSet : global::System.Data.DataSet {
        ...
        public partial class ClienteDataTable : global::System.Data.TypedTableBase<ClienteRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ClienteRow AddClienteRow(long idCliente, string nombre, string apellido, string mail, string direccion, string codigoPostal, decimal DNI, decimal telefono, System.DateTime fecha_nac) {
...
namespace PagoAgilFrba.GD2C2017DataSetTableAdapters {
    ...
    public partial class ClienteTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [WEST_WORLD].[Cliente] ([idCliente], [nombre], [apellido], [mail], [direccion], [codigoPostal], [DNI], [telefono], [fecha_nac]) VALUES (@idCliente, @nombre, @apellido, @mail, @direccion, @codigoPostal, @DNI, @telefono, @fecha_nac);
SELECT idCliente, nombre, apellido, mail, direccion, codigoPostal, DNI, telefono, fecha_nac FROM WEST_WORLD.Cliente WHERE (idCliente = @idCliente)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [WEST_WORLD].[Cliente] SET [idCliente] = @idCliente, [nombre] = @nombre, [apellido] = @apellido, [mail] = @mail, [direccion] = @direccion, [codigoPostal] = @codigoPostal, [DNI] = @DNI, [telefono] = @telefono, [fecha_nac] = @fecha_nac WHERE (([idCliente] = @Original_idCliente) AND ([nombre] = @Original_nombre) AND ([apellido] = @Original_apellido) AND ([mail] = @Original_mail) AND ([direccion] = @Original_direccion) AND ([codigoPostal] = @Original_codigoPostal) AND ([DNI] = @Original_DNI) AND ([telefono] = @Original_telefono) AND ([fecha_nac] = @Original_fecha_nac));
SELECT idCliente, nombre, apellido, mail, direccion, codigoPostal, DNI, telefono, fecha_nac FROM WEST_WORLD.Cliente WHERE (idCliente = @idCliente)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT idCliente, nombre, apellido, mail, direccion, codigoPostal, DNI, telefono," +
                " fecha_nac FROM WEST_WORLD.Cliente";
        ...
        public virtual int Delete(long Original_idCliente, string Original_nombre, string Original_apellido, string Original_mail, string Original_direccion, string Original_codigoPostal, decimal Original_DNI, decimal Original_telefono, System.DateTime Original_fecha_nac) {
        ...
        public virtual int Insert(long idCliente, string nombre, string apellido, string mail, string direccion, string codigoPostal, decimal DNI, decimal telefono, System.DateTime fecha_nac) {
            ...
            this.Adapter.InsertCommand.Parameters[6].Value = ((decimal)(DNI));
        ...
        public virtual int Update(
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((decimal)(DNI));
        ...
        public virtual int Update(
                    ...
                    decimal Original_telefono, 
                    System.DateTime Original_fecha_nac) {
            return this.Update(Original_idCliente, nombre, apellido, mail, direccion, codigoPostal, DNI, telefono, fecha_nac, Original_idCliente, Original_nombre, Original_apellido, Original_mail, Original_direccion, Original_codigoPostal, Original_DNI, Original_telefono, Original_fecha_nac);
        }
    }
